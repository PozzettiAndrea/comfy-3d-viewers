/**
 * ComfyUI-PyVista — Generic Text Report Renderer
...
const PYVISTA_TEXT_REPORT_NODES = [
    // Filters
    "PyVistaComputeNormals",
    "PyVistaClip",
    "PyVistaSlice",
    "PyVistaThreshold",
    "PyVistaDecimate",
    ...
    "PyVistaExtrude",
    "PyVistaDelaunay",
    "PyVistaReconstructSurface",
    // Transforms
    "PyVistaTransform",
    // Sampling
    "PyVistaSampleOverLine",
    "PyVistaInterpolate",
    // Spatial
    "PyVistaRayTrace",
    "PyVistaGeodesic",
    ...
    "PyVistaVoxelize",
    // Primitives
    "PyVistaCreatePrimitive",
    "PyVistaCreateParametricSurface",
    // IO
    "PyVistaLoadMeshio",
    "PyVistaSaveMeshio",
    "PyVistaConvertMesh",
    // Visualization
    "PyVistaCreatePlotter",
    "PyVistaAddToPlotter",
];
...
app.registerExtension({
    name: "pyvista.text_report",

    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (!PYVISTA_TEXT_REPORT_NODES.includes(nodeData.name)) return;
